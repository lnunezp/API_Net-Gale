...
{
    public class Post : Gale.REST.Http.HttpReadActionResult<Models.CREATECLIENT>
    {
        /// <summary>
        /// METODO /SERVICIO "PARA CREAR NUEVOS CLIENTES"
        /// </summary>
        /// <param name="model"></param>
        public Post(Models.CREATECLIENT model) : base(model) { }

        public override System.Threading.Tasks.Task<System.Net.Http.HttpResponseMessage> ExecuteAsync(System.Threading.CancellationToken cancellationToken)
        {
            using (Gale.Db.DataService svc = new Gale.Db.DataService("PA_INS_CLIENTE"))
            {
